...
const CommentIcon: React.FC<IconProps> = ({size = '21', color = '#E7E7E7'}) => {
  return (
    <svg
      width={size}
      height={size}
...
const CommentIconOutlined: React.FC<IconProps> = ({
  size = '20',
  color = '#DBDBDB',
}) => {
  return (
...
const SearchIcon: React.FC<IconProps> = ({size = '24', color = '#202020'}) => {
  return (
    <svg
      width={size}
      height={size}
...
const DefaultCheckIcon: React.FC<IconProps> = ({
  size = '20',
  color = '#707070',
}) => {
  return (
...
const YellowCheckIcon: React.FC<IconProps> = ({
  size = '20',
  color = '#131313',
  innerColor = '#FE7156',
}) => {
...
const ArrowLeftIcon: React.FC<IconProps> = ({color = '#1313133'}) => {
  return (
    <svg
      width="14"
      height="10"
...
const ImageUploadIcon: React.FC<IconProps> = ({color = '#B4B4B4'}) => {
  return (
...
const TitleIcon: React.FC<IconProps> = ({size = '24', color = 'black'}) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
      ...
      fill="none"
    >
      <path d="M5 5V8H10.5V20H13.5V8H19V5H5Z" fill={color} />
    </svg>
  )
}

const ImageIcon: React.FC<IconProps> = ({size = '24', color = '#191919'}) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const TagIcon: React.FC<IconProps> = ({size = '24', color = 'black'}) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const BeforeIcon: React.FC<IconProps> = ({size = '24', color = '#B4B4B4'}) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const BeforeIconBlack: React.FC<IconProps> = ({
  size = '24',
  color = 'black',
}) => {
  return (
...
const AfterIcon: React.FC<IconProps> = ({size = '24', color = '#B4B4B4'}) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const AfterIconBlack: React.FC<IconProps> = ({
  size = '24',
  color = 'black',
}) => {
  return (
...
const FilterIcon: React.FC<IconProps> = ({size = '24', color = 'black'}) => {
  return (
    <svg
      ...
      fill="none"
    >
      <line x1="2" y1="4.5" x2="22" y2="4.5" stroke={color} />
      <line x1="2" y1="18.5" x2="22" y2="18.5" stroke={color} />
      <line x1="2" y1="11.5" x2="22" y2="11.5" stroke={color} />
      <circle cx="16.5" cy="11.5" r="2" fill="white" stroke={color} />
      <circle cx="6.5" cy="4.5" r="2" fill="white" stroke={color} />
      <circle cx="6.5" cy="18.5" r="2" fill="white" stroke={color} />
    </svg>
  )
}

const HeartIcon: React.FC<IconProps> = ({size = '24', color = '#FB196A'}) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
